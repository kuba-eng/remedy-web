...
import { f as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-Dsbb7VeV.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-LlwtzBSE.js";
//#region src/agents/cli-runner.ts
async function runCliAgent(params) {
	const { prepareCliRunContext } = await import("./prepare.runtime-DRpfEqxt.js");
	return runPreparedCliAgent(await prepareCliRunContext(params));
}
async function runPreparedCliAgent(context) {
	const { executePreparedCliRun } = await import("./execute.runtime-CNpHQch-.js");
