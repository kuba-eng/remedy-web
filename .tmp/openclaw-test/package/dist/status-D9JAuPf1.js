...
function loadGatewayProbeAuthModule() {
	gatewayProbeAuthModulePromise ??= import("./probe-auth-CsieyBmE.js");
...
function loadDaemonProbeModule() {
	daemonProbeModulePromise ??= import("./probe-Ca2XanQ9.js");
	return daemonProbeModulePromise;
}
function loadRestartHealthModule() {
	restartHealthModulePromise ??= import("./restart-health-EX9r9mSc.js");
