...
import "./accounts-RG1APH-E.js";
import "./runtime-api-Bqx6A-_T.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-B8zsao5g.js";
import { t as sendMessageZalo } from "./send-DrgQ_6Eu.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-CIwnu3ol.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-CWL8VF6m.js");
