...
import { n as listConfiguredWebSearchProviders } from "./runtime-DVDA4MXH.js";
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-zEktnI48.js";
import { i as formatControlUiSshHint, m as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-zM35EBu2.js";
import { r as installCompletion } from "./completion-runtime-CdQtJ06K.js";
...
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-jECbZcEk.js";
import { t as runTui } from "./tui-CQlttLvS.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DSbz8oyy.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-BjHDnlfy.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-BjHDnlfy.js");
