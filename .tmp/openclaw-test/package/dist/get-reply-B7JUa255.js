...
import { i as normalizeChannelId, r as listChannelPlugins, t as getChannelPlugin } from "./registry-Cxw9jxnD.js";
...
import { b as resetRegisteredAgentHarnessSessions } from "./loader-mal3JrX6.js";
...
import { m as resolveModelRefFromString } from "./model-selection-CaDDjSLe.js";
import { S as resolveGroupSessionKey, a as resolveSessionStoreEntry, c as updateSessionStore, m as resolveMaintenanceConfigFromInput, v as deriveSessionMetaPatch } from "./store-DcFdQ7im.js";
...
import { n as resolveSessionKey } from "./session-key-C2dPjytq.js";
...
import { t as resolveAndPersistSessionFile } from "./session-file-JC6HW0sz.js";
...
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-C0hh0kYg.js";
...
import { r as disposeSessionMcpRuntime } from "./pi-bundle-mcp-tools-B7xUtJY4.js";
...
import { f as fireAndForgetHook, n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-BxmWtGkD.js";
...
import { t as resolveQueueSettings } from "./settings-runtime-rEmLif_F.js";
...
import { t as resolveChannelModelOverride } from "./model-overrides-BxhThqLW.js";
import { t as normalizeGroupActivation } from "./group-activation-DL8r3H_X.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-C6uVqbsY.js";
import { t as resolveFastModeState } from "./fast-mode-BP5Jce-x.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-CZ41jojt.js";
...
import { t as parseInlineDirectives } from "./directive-handling.parse-DLgQ5Qi4.js";
...
import { t as resolveStoredModelOverride } from "./stored-model-override-CRhW0GK2.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-W6-kkEwb.js";
...
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-DOCNHQAR.js";
...
import { t as drainFormattedSystemEvents } from "./session-system-events-D-iGRKsw.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-DGm7pv-N.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-pL4TFaY3.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-ufsnRCYl.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-M40d1K5s.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-ItqIkXEL.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-BXl-YmoF.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-vIDxLXCs.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-CusM04b2.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-C4pHSq4C.js");
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-C4pHSq4C.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		agentId,
		skillFilter
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createOpenClawTools } = await import("./openclaw-tools.runtime-xYLoAnSm.js");
	...
	if (!isStopLikeInbound && targetSessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-D9PmrWUh.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry: targetSessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (handleInlineStatus) {
		const { buildStatusReply } = await import("./commands.runtime-DBE-KPDM.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-DBE-KPDM.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-5k8EBTwM.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-CbnrYrPE.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-D0xbUvN-.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-5D3BWRGK.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-hj4dPtAu.js");
...
async function forkSessionFromParent(params) {
	return (await import("./session-fork.runtime-BZd8iWQ-.js")).forkSessionFromParentRuntime(params);
}
//#endregion
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-D8b8ng3x.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-Cz1ozp70.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-CM6CfSdN.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-CYQZW0-V.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-E7iNz2rj.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-BQH3ur8I.js");
