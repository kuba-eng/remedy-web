...
import { J as normalizeGoogleApiBaseUrl } from "./io-CnRB4FES.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-CAPWz-u0.js";
...
import { y as listRegisteredAgentHarnesses } from "./loader-mal3JrX6.js";
...
import { F as resolveProviderSystemPromptContribution, I as resolveProviderTextTransforms, K as transformProviderSystemPrompt, x as prepareProviderRuntimeAuth } from "./provider-runtime-BeAV2xDF.js";
...
import { t as ensureContextEnginesInitialized } from "./init-UUalBaEU.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-Y29YX8fW.js";
import { a as resolveToolCallArgumentsEncoding } from "./provider-model-compat-BCZKgWtR.js";
...
import { $ as assessLastAssistantMessage, A as SAFETY_MARGIN, B as readLastCacheTtlTimestamp, C as trackSessionManagerAccess, D as getDmHistoryLimitFromSessionKey, E as buildEmbeddedMessageActionDiscoveryInput, G as resolveLiveToolResultMaxChars, H as shouldAllowProviderOwnedThinkingReplay, J as truncateOversizedToolResultsInSessionManager, K as sessionLikelyHasOversizedToolResults, O as limitHistoryTurns, Q as createPreparedEmbeddedPiSettingsManager, R as resolveCompactionTimeoutMs, S as prewarmSessionFile, T as validateReplayTurns, U as guardSessionManager, V as resolveTranscriptPolicy, W as estimateToolResultReductionPotential, X as installToolResultContextGuard, Y as installContextEngineLoopHook, Z as repairSessionFileIfNeeded, _ as describeEmbeddedAgentStreamStrategy, at as filterHeartbeatPairs, b as resolveEmbeddedAgentStreamFn, c as buildEmbeddedCompactionRuntimeContext, ct as captureCompactionCheckpointSnapshot, d as mapThinkingLevel, et as dropThinkingBlocks, f as splitSdkTools, ft as persistSessionCompactionCheckpoint, g as createSystemPromptOverride, h as buildEmbeddedSystemPrompt, it as resolveChannelCapabilities, j as estimateMessagesTokens, k as buildEmbeddedExtensionFactories, l as resolveEmbeddedCompactionTarget, lt as cleanupCompactionCheckpointSnapshot, m as applySystemPromptOverrideToSession, n as asCompactionHookRunner, nt as releaseWsSession, p as collectAllowedToolNames, pt as resolveSessionCompactionCheckpointReason, q as truncateOversizedToolResultsInSession, rt as buildStreamErrorAssistantMessage, s as runPostCompactionSideEffects, t as readPiModelContextTokens, tt as createBundleLspToolRuntime, u as flushPendingToolResultsAfterIdle, v as resolveEmbeddedAgentApiKey, w as sanitizeSessionHistory, x as resolveEmbeddedRunSkillEntries, y as resolveEmbeddedAgentBaseStreamFn, z as isCacheTtlEligibleProvider } from "./model-context-tokens-Cs_NVRAP.js";
import { i as enqueueCommandInLane, o as getQueueSize } from "./command-queue-BLDIg9zn.js";
import { a as formatContextWindowWarningMessage, i as formatContextWindowBlockMessage, n as CONTEXT_WINDOW_WARN_BELOW_TOKENS, o as resolveContextWindowInfo, r as evaluateContextWindowGuard, t as CONTEXT_WINDOW_HARD_MIN_TOKENS } from "./context-window-guard-KVnigGp2.js";
import { a as extractToolResultText, c as isToolResultTimedOut, d as isMessagingToolSendAction, f as normalizeEmbeddedAgentRuntime, i as extractToolResultMediaArtifact, l as sanitizeToolResult, m as resolveEmbeddedAgentRuntime, n as extractMessagingToolSend, o as filterToolResultMediaUrls, p as resolveEmbeddedAgentHarnessFallback, r as extractToolErrorMessage, s as isToolResultError, t as buildEmbeddedAttemptToolRunContext, u as isMessagingTool } from "./attempt.tool-run-context-Ca6EGee1.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, o as startsWithSilentToken, r as isSilentReplyPayloadText, s as stripLeadingSilentToken } from "./tokens-C0hh0kYg.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-C0jXikwI.js";
...
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolCapabilities, s as resolveChannelMessageToolHints, u as getPluginToolMeta } from "./channel-tools-Bn2KPJpS.js";
import { n as buildTtsSystemPromptHint } from "./tts-Ba-Z27Wi.js";
import { t as isReasoningTagProvider } from "./provider-utils-B0TksXWV.js";
...
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, o as resolveHeartbeatPromptForSystemPrompt, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-C-CHHEiH.js";
...
import { n as formatRawAssistantErrorForUi } from "./assistant-error-format-CjfSzXd5.js";
import { C as isTimeoutErrorMessage, D as parseExecApprovalResultText, d as stableStringify$1, l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-hDikFgO6.js";
import { _ as parseImageDimensionError, a as formatAssistantErrorText, c as isCloudCodeAssistFormatError, d as isFailoverAssistantError, f as isFailoverErrorMessage, i as extractObservedOverflowTokenCount, l as isCompactionFailureError, m as isRateLimitAssistantError, o as isAuthAssistantError, p as isLikelyContextOverflowError, s as isBillingAssistantError, t as classifyFailoverReason, v as parseImageSizeError } from "./errors-Dsbb7VeV.js";
...
import { a as isTimeoutError, n as coerceToFailoverError, r as describeFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-LlwtzBSE.js";
import { t as buildModelAliasLines } from "./model-alias-lines-C__EBjO0.js";
import "./auth-profiles-Dql9QKLn.js";
import { f as resolveProfilesUnavailableReason, l as markAuthProfileFailure, n as resolveAuthProfileOrder, s as isProfileInCooldown, t as resolveAuthProfileEligibility, u as markAuthProfileUsed } from "./order-CPRgs5DG.js";
import { r as markAuthProfileGood } from "./profiles-C8m60sLi.js";
...
import { c as resolveModelAuthMode, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride, u as shouldPreferExplicitConfigApiKeyAuth } from "./model-auth-8pQph1lv.js";
import { a as shouldUseOpenAIWebSocketTransport, c as supportsModelTools, i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, o as logProviderToolSchemaDiagnostics, r as resolveAttemptSpawnWorkspaceDir, s as normalizeProviderToolSchemas, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-BaAu7Y0G.js";
import { l as sanitizeTransportPayloadText, n as registerProviderStreamForModel, s as mergeTransportHeaders, u as buildGuardedModelFetch } from "./anthropic-vertex-stream-CJjqZvdc.js";
import { d as sanitizeRuntimeProviderRequestOverrides, s as resolveProviderRequestConfig } from "./provider-request-config-D26WaAea.js";
...
import { i as getOrCreateSessionMcpRuntime, n as materializeBundleMcpToolsForRun, r as disposeSessionMcpRuntime } from "./pi-bundle-mcp-tools-B7xUtJY4.js";
...
import { u as parseReplyDirectives } from "./deliver-Do3uwqpG.js";
...
import { a as shouldAllowCooldownProbeForReason, i as LiveSessionModelSwitchError, o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-35X6aYa6.js";
import { _ as isStrictAgenticExecutionContractActive, i as findActiveSessionTask, n as buildActiveVideoGenerationTaskPromptContextForSession, r as buildActiveMusicGenerationTaskPromptContextForSession, v as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-DiALg6WS.js";
...
import { a as stripDowngradedToolCallText } from "./assistant-visible-text-DfRmY5Zd.js";
...
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-DJx4psxd.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-AF-jFwS7.js";
...
import { c as recordTaskRunProgressByRunId, d as startTaskRunByRunId, i as createQueuedTaskRun, o as failTaskRunByRunId, r as completeTaskRunByRunId, u as setDetachedTaskDeliveryStatusByRunId } from "./task-executor-NBG92XvQ.js";
import { o as resolveGlobalLane, s as resolveSessionLane } from "./queue-YLhvFyIi.js";
import { l as setActiveEmbeddedRun, n as clearActiveEmbeddedRun, u as updateActiveEmbeddedRunSnapshot } from "./runs-4UeQ_dZp.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-DhlCUc8s.js";
import { t as resolveAgentTimeoutMs } from "./timeout-CxW3WOrq.js";
import { c as resolveSkillsPromptForRun } from "./skills-Dn9ygksH.js";
...
import { a as sanitizeToolUseResultPairing, t as isRedactedSessionsSpawnAttachment } from "./session-transcript-repair-CGy5XjJZ.js";
...
import { a as resolveCacheRetention, i as isGooglePromptCacheEligible, n as resolveAgentTransportOverride, t as applyExtraParamsToAgent } from "./extra-params-plhpzG_s.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-DFrJghWk.js";
import { n as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-QYMZBVDa.js";
import { t as detectAndLoadPromptImages } from "./images-BXD_c4El.js";
import "./ollama-runtime-5PFjSZzA.js";
import { n as resolveModelAsync } from "./model-44DYbL6S.js";
import { a as resolveStoredSessionKeyForSessionId, i as resolveSessionKeyForRequest, n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-_KR7SFEy.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-D6zOlPmo.js";
...
async function reconcileSessionStoreCompactionCountAfterSuccess(params) {
	const { reconcileSessionStoreCompactionCountAfterSuccess: reconcile } = await import("./pi-embedded-subscribe.handlers.compaction.runtime-vBJxjY-8.js");
...
function loadExecApprovalReply() {
	execApprovalReplyModulePromise ??= import("./exec-approval-reply-WaZmdqIY.js");
...
function loadBeforeToolCall() {
	beforeToolCallModulePromise ??= import("./pi-tools.before-tool-call-D9TUzWZE.js");
...
function resolveUnknownToolGuardThreshold(loopDetection) {
	if (loopDetection?.enabled !== true) return;
	return loopDetection.unknownToolThreshold ?? 10;
}
