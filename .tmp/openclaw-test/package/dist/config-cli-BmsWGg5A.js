...
import { a as resolveSecretRefValue } from "./resolve-GyhEWSz1.js";
import { w as SecretProviderSchema } from "./zod-schema.core-DvxunW4u.js";
import { b as validateConfigObjectRaw, l as readConfigFileSnapshot, v as collectUnsupportedSecretRefPolicyIssues } from "./io-CnRB4FES.js";
...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-CbiKt_ns.js";
import { i as redactConfigObject, n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-x_mfyq9R.js";
import { n as setCommandJsonMode } from "./json-mode-DTVLIC-b.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-DIyNwpzi.js");
