...
import { a as loadConfig, g as writeConfigFile, l as readConfigFileSnapshot, r as createConfigIO } from "./io-CnRB4FES.js";
...
import { r as resolveGatewayService } from "./service-CSzcWm5r.js";
...
import { a as markGatewaySigusr1RestartHandled, i as isGatewaySigusr1RestartExternallyAllowed, l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart, t as consumeGatewaySigusr1RestartAuthorization } from "./restart-CuQak1Gc.js";
import { d as waitForActiveEmbeddedRuns, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-4UeQ_dZp.js";
...
import { t as readSecretFromFile } from "./secret-file-BFO-ozzU.js";
import { o as handleReset } from "./onboard-helpers-zM35EBu2.js";
import { n as buildGatewayDiscoveryTarget } from "./gateway-discovery-targets-CsFv4sbO.js";
import { o as resolveControlUiRootSync } from "./control-ui-assets-HjENoSk_.js";
import { n as acquireGatewayLock, t as GatewayLockError } from "./gateway-lock-CUHYEfEH.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-BefVMTYH.js";
...
async function runGatewayCommand$1(opts) {
	...
	const { startGatewayServer } = await withProgress({
		...
		indeterminate: true
	}, async () => import("./server-BboskqrT.js"));
...
function loadConfigModule() {
	configModulePromise ??= import("./read-best-effort-config.runtime-D-skH54A.js");
	return configModulePromise;
}
function loadGatewayStatusModule() {
	gatewayStatusModulePromise ??= import("./gateway-status-44ow8VUn.js");
	return gatewayStatusModulePromise;
}
function loadGatewayHealthModule() {
	gatewayHealthModulePromise ??= import("./health-DQpzwpLE.js");
	return gatewayHealthModulePromise;
}
function loadBonjourDiscoveryModule() {
	bonjourDiscoveryModulePromise ??= import("./bonjour-discovery-AulQ-sSp.js");
	return bonjourDiscoveryModulePromise;
}
function loadWideAreaDnsModule() {
	wideAreaDnsModulePromise ??= import("./widearea-dns-CWGKPjEG.js");
	return wideAreaDnsModulePromise;
}
function loadHealthStyleModule() {
	healthStyleModulePromise ??= import("./health-style-DFlYR1Pa.js");
	return healthStyleModulePromise;
}
function loadUsageFormatModule() {
	usageFormatModulePromise ??= import("./usage-format-DwhOfRtk.js");
