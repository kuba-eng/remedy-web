...
import "./api-YdWnsBIl.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-BIQCc0G2.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-1pp-NiSS.js";
import { a as convertPcmToMulaw8k, t as isProviderStatusTerminal } from "./call-status-CuV4k9J2.js";
import { t as getHeader } from "./http-headers-BqA5JMfA.js";
...
var VoiceCallWebhookServer = class {
	...
	*/
	async initializeMediaStreaming() {
		...
		const { getRealtimeTranscriptionProvider, listRealtimeTranscriptionProviders } = await import("./realtime-transcription.runtime-CWW6nnfr.js");
  ...
  <Play loop="0">https://s3.amazonaws.com/com.twilio.music.classical/BusyStrings.mp3</Play>
	...
	*/
	async handleInboundResponse(callId, userMessage) {
		...
		try {
			const { generateVoiceResponse } = await import("./response-generator-_iGWo5tI.js");
...
async function resolveProvider(config) {
	...
	switch (config.provider) {
		case "telnyx": {
			const { TelnyxProvider } = await import("./telnyx-09_1S1aI.js");
		...
		case "twilio": {
			const { TwilioProvider } = await import("./twilio-DkHPbmRg.js");
		...
		case "plivo": {
			const { PlivoProvider } = await import("./plivo-Bjzs2vlv.js");
		...
		case "mock": {
			const { MockProvider } = await import("./mock-BQ5LlCFa.js");
...
async function resolveRealtimeProvider(params) {
	const { getRealtimeVoiceProvider, listRealtimeVoiceProviders } = await import("./realtime-voice.runtime-B861rvI1.js");
	const resolution = resolveConfiguredCapabilityProvider({
...
async function createVoiceCallRuntime(params) {
	...
	if (realtimeProvider) {
		const { RealtimeCallHandler } = await import("./realtime-handler-D6SVEnrR.js");
