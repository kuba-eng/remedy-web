...
import { i as resolveDirectDmAuthorizationOutcome, o as resolveSenderCommandAuthorizationWithRuntime } from "./command-auth-B2fYrsNq.js";
import { n as isZaloSenderAllowed, t as evaluateZaloGroupAccess } from "./group-access-ccBWMFaX.js";
import { t as getZaloRuntime } from "./runtime-api-Bqx6A-_T.js";
import { a as getUpdates, c as sendMessage, l as sendPhoto, n as ZaloApiError, o as getWebhookInfo, r as deleteWebhook, s as sendChatAction, t as resolveZaloProxyFetch, u as setWebhook } from "./proxy-B8zsao5g.js";
...
async function handleZaloWebhookRequest(req, res) {
	const { handleZaloWebhookRequest: handleZaloWebhookRequestInternal } = await import("./monitor.webhook-rkEtbwOC.js");
...
async function monitorZaloProvider(options) {
	...
	try {
		if (useWebhook) {
			const { registerZaloWebhookTarget } = await import("./monitor.webhook-rkEtbwOC.js");
