...
import { C as isRevokedProxyError, I as readNestedString, S as formatUnknownError, _ as loadMSTeamsSdkWithAuth, b as classifyMSTeamsSendError, g as createMSTeamsTokenProvider, h as createMSTeamsAdapter, p as readAccessToken, v as buildUserAgent, x as formatMSTeamsSendErrorHint } from "./graph-users-BjoUkC4n.js";
...
async function probeMSTeams(cfg) {
	...
	try {
		...
		if (cfg?.delegatedAuth?.enabled) try {
			const { loadDelegatedTokens } = await import("./token-BmyzULsq.js");
