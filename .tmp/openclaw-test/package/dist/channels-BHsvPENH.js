...
import { r as replaceConfigFile } from "./config-Cs9i9cxO.js";
import { i as loadAuthProfileStore } from "./store-CIgDVWuz.js";
import "./plugins-CMbEm8J1.js";
import "./logging-DW_bR-rY.js";
import { r as createMessageActionDiscoveryContext, s as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-ByYCBc6Z.js";
import "./auth-profiles-Dql9QKLn.js";
import { r as callGateway } from "./call-DKkbbXOF.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-DKs8wYPx.js";
...
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-D2ui8Zu3.js";
...
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-kZ5NsgPI.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-h-sTlsPh.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-C3s-SZqp.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-D5HRMIlC.js";
import { t as parseLogLine } from "./parse-log-line-DHtPmxa4.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-DXbaa74x.js";
import { n as createChannelOnboardingPostWriteHookCollector, o as isCatalogChannelInstalled, r as runCollectedChannelOnboardingPostWriteHooks } from "./onboard-channels-CyKucAOs.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-aDBLzl4x.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-C-MWMPzR.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-giyygNkz.js"), import("./onboard-channels-Ci7zr3Q-.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-gFf1cSB3.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-gFf1cSB3.js");
			const prompter = createClackPrompter();
