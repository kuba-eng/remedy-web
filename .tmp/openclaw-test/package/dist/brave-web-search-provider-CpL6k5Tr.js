...
import { a as resolveBraveConfig, i as normalizeBraveLanguageParams, n as mapBraveLlmContextResults, o as resolveBraveMode, r as normalizeBraveCountry, t as createBraveSchema } from "./brave-web-search-provider.shared-Ddmd9ue8.js";
...
function createBraveToolDefinition(searchConfig) {
	return {
		...
		execute: async (args) => {
			const { executeBraveSearch } = await import("./brave-web-search-provider.runtime-DZebj3xw.js");
