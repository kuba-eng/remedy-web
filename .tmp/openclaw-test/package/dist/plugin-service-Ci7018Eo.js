...
import { nn as ErrorCodes, rn as errorShape } from "./protocol-DhqQl3eU.js";
...
import { i as stringEnum, r as optionalStringEnum } from "./typebox-DEskULP8.js";
import { a as selectDefaultNodeFromList, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-C3_wlovc.js";
...
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-DFtFoh_g.js";
...
import { a as respondUnavailableOnNodeInvokeError, s as safeParseJson } from "./startup-auth-9b1l_DxU.js";
...
import "./browser-setup-tools-BphHOhTh.js";
import "./channel-actions-zUgiO578.js";
import { b as normalizeBrowserFormField, x as normalizeBrowserFormFieldValue } from "./chrome-BkIr9Pl1.js";
import { d as resolveExistingPathsWithinRoot, n as DEFAULT_AI_SNAPSHOT_MAX_CHARS, u as DEFAULT_UPLOAD_DIR } from "./utils-DBvQ4IAC.js";
import { d as redactCdpUrl } from "./cdp.helpers-BGBbt6Zm.js";
import { i as getBrowserProfileCapabilities } from "./server-context-CKUktJNU.js";
import { n as resolveProfile, t as resolveBrowserConfig } from "./config-DYQVittm.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-By5DvHlO.js";
import { c as browserOpenTab, d as browserSnapshot, f as browserStart, g as browserTabs, i as browserCloseTab, l as browserProfiles, m as browserStop, n as trackSessionBrowserTab, p as browserStatus, r as untrackSessionBrowserTab, s as browserFocusTab } from "./session-tab-registry-vttHTDMn.js";
import { a as createBrowserRouteDispatcher, r as startBrowserControlServiceFromConfig, t as createBrowserControlContext } from "./control-service-BMRYZmsB.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-Db-kMEBb.js"),
