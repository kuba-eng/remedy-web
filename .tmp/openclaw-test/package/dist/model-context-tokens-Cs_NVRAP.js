...
import { i as normalizeChannelId } from "./registry-Cxw9jxnD.js";
...
import { a as normalizePluginsConfig, s as resolveEffectivePluginActivationState } from "./config-state-spVXfsqB.js";
...
import { d as getCompactionProvider } from "./loader-mal3JrX6.js";
...
import { u as resolveGatewaySessionStoreTarget } from "./session-utils-B9Je2mR_.js";
...
import { o as resolveContextWindowInfo } from "./context-window-guard-KVnigGp2.js";
import { a as isSilentReplyText } from "./tokens-C0hh0kYg.js";
...
import { a as isTimeoutError } from "./failover-error-LlwtzBSE.js";
import { a as createBoundaryAwareStreamFnForModel, c as mergeTransportMetadata, d as normalizeOpenAIReasoningEffort, f as mapOpenAIReasoningEffortForModel, h as resolveOpenAIStrictToolSetting, m as resolveOpenAIStrictToolFlagForInventory, p as normalizeOpenAIStrictToolParameters, t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-CJjqZvdc.js";
import { d as resolveDebugProxySettings, n as captureWsEvent, u as createDebugProxyWebSocketAgent } from "./runtime-CdS7ehWO.js";
import { c as resolveProviderRequestPolicyConfig, i as getModelProviderRequestTransport, r as buildProviderRequestTlsClientOptions } from "./provider-request-config-D26WaAea.js";
import { t as log$4 } from "./logger-CMwqWyWx.js";
import { b as resolveOpenAITextVerbosity } from "./proxy-stream-wrappers-ba2T18hy.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-NUMoTji1.js";
import { n as loadEnabledBundleLspConfig } from "./bundle-lsp-C-nKJwPq.js";
import { a as loadEmbeddedPiMcpConfig, o as describeStdioMcpServerLaunchConfig, s as resolveStdioMcpServerLaunchConfig } from "./pi-bundle-mcp-tools-B7xUtJY4.js";
...
import { a as toToolDefinitions } from "./pi-tool-definition-adapter-DJx4psxd.js";
...
import { a as sanitizeToolUseResultPairing, i as sanitizeToolCallInputs, n as makeMissingToolResult, o as stripToolResultDetails, r as repairToolUseResultPairing } from "./session-transcript-repair-CGy5XjJZ.js";
import { i as resolveUserTimezone } from "./date-time-CH5CpFpu.js";
import { y as shouldPreserveThinkingBlocks } from "./provider-model-shared-DTkCg-KW.js";
import { n as isAnthropicFamilyCacheTtlEligible, r as isAnthropicModelRef } from "./anthropic-cache-control-payload-DxuIhA17.js";
import { i as isGooglePromptCacheEligible } from "./extra-params-plhpzG_s.js";
...
import { r as wrapUntrustedPromptDataBlock, t as buildAgentSystemPrompt } from "./system-prompt-CIiVO64-.js";
import { t as estimateStringChars } from "./cjk-chars-B5qLq09z.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-gDAw4ajX.js";
...
//#endregion
export { assessLastAssistantMessage as $, SAFETY_MARGIN as A, readLastCacheTtlTimestamp as B, trackSessionManagerAccess as C, getDmHistoryLimitFromSessionKey as D, buildEmbeddedMessageActionDiscoveryInput as E, consumeCompactionSafeguardCancelReason as F, resolveLiveToolResultMaxChars as G, shouldAllowProviderOwnedThinkingReplay as H, setCompactionSafeguardCancelReason as I, truncateOversizedToolResultsInSessionManager as J, sessionLikelyHasOversizedToolResults as K, compactWithSafetyTimeout as L, hasMeaningfulConversationContent as M, isRealConversationMessage as N, limitHistoryTurns as O, readPostCompactionContext as P, createPreparedEmbeddedPiSettingsManager as Q, resolveCompactionTimeoutMs as R, prewarmSessionFile as S, validateReplayTurns as T, guardSessionManager as U, resolveTranscriptPolicy as V, estimateToolResultReductionPotential as W, installToolResultContextGuard as X, installContextEngineLoopHook as Y, repairSessionFileIfNeeded as Z, describeEmbeddedAgentStreamStrategy as _, runAfterCompactionHooks as a, filterHeartbeatPairs as at, resolveEmbeddedAgentStreamFn as b, buildEmbeddedCompactionRuntimeContext as c, captureCompactionCheckpointSnapshot as ct, mapThinkingLevel as d, listSessionCompactionCheckpoints as dt, dropThinkingBlocks as et, splitSdkTools as f, persistSessionCompactionCheckpoint as ft, createSystemPromptOverride as g, buildEmbeddedSystemPrompt as h, estimateTokensAfterCompaction as i, resolveChannelCapabilities as it, estimateMessagesTokens as j, buildEmbeddedExtensionFactories as k, resolveEmbeddedCompactionTarget as l, cleanupCompactionCheckpointSnapshot as lt, applySystemPromptOverrideToSession as m, asCompactionHookRunner as n, releaseWsSession as nt, runBeforeCompactionHooks as o, isHeartbeatOkResponse as ot, collectAllowedToolNames as p, resolveSessionCompactionCheckpointReason as pt, truncateOversizedToolResultsInSession as q, buildBeforeCompactionHookMetrics as r, buildStreamErrorAssistantMessage as rt, runPostCompactionSideEffects as s, isHeartbeatUserMessage as st, readPiModelContextTokens as t, createBundleLspToolRuntime as tt, flushPendingToolResultsAfterIdle as u, getSessionCompactionCheckpoint as ut, resolveEmbeddedAgentApiKey as v, sanitizeSessionHistory as w, resolveEmbeddedRunSkillEntries as x, resolveEmbeddedAgentBaseStreamFn as y, isCacheTtlEligibleProvider as z };
