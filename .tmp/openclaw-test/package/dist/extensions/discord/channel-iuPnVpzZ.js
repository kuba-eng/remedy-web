import { n as listDiscordAccountIds, o as resolveDiscordAccount } from "./accounts-C_rKbFDE.js";
import { a as projectCredentialSnapshotFields, n as PAIRING_APPROVED_MESSAGE, o as resolveConfiguredFromCredentialStatuses, r as buildTokenChannelStatusSummary, t as DEFAULT_ACCOUNT_ID } from "./channel-api-CxgW0uwG.js";
import { t as parseDiscordTarget } from "./target-parsing-DAJEJpie.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-Byw0kl0z.js";
import { o as shouldSuppressLocalDiscordExecApprovalPrompt, t as DiscordUiContainer } from "./ui-C15yAlFv.js";
import { t as getDiscordApprovalCapability } from "./approval-native-hXFN3YvK.js";
import { t as discordMessageActions$1 } from "./channel-actions-CNGGjVq6.js";
import { r as resolveDiscordCurrentConversationIdentity, t as isLikelyDiscordVideoMedia } from "./media-detection-C3mnN0T0.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-C8h5xCHh.js";
import { n as normalizeDiscordMessagingTarget, r as normalizeDiscordOutboundTarget, t as looksLikeDiscordTargetId } from "./normalize-Bbq-vRGo.js";
import { t as getDiscordRuntime } from "./runtime-BZ2wMlw0.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-BgZUy_YA.js";
import { n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-C9Le2uSl.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-dFhQ_SXI.js").then((n) => n.t));
const loadDiscordSecurityAuditModule = createLazyRuntimeModule(() => import("./security-audit.runtime-CKOBqhQC.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-C2tOEMQp.js").then((n) => n.n));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-CbiL5wQt.js").then((n) => n.n));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-B2vvtbC5.js").then((n) => n.a));
const require = createRequire(import.meta.url);
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-XM-20kD9.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-CkvPEt0E.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-CsMjr8EC.js").then((n) => n.n);
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-aQ7Ta_xO.js").then((n) => n.t);
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-DnRfJ26O.js").then((n) => n.t);
