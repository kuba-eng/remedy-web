...
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CKCsxwbZ.js";
...
import { l as shouldSuppressLocalMatrixExecApprovalPrompt, m as normalizeMatrixUserId, p as normalizeMatrixAllowList } from "./exec-approvals-zTCPoM3k.js";
...
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta, v as matrixApprovalCapability } from "./session-store-metadata-6E06cZkY.js";
import { t as formatMatrixErrorMessage } from "./errors-DxFYl2Z6.js";
import { n as legacyConfigRules, r as normalizeCompatibilityConfig, t as matrixOnboardingAdapter } from "./setup-surface-Cf5Tk0X-.js";
import { i as autoPrepareLegacyMatrixCrypto, o as autoMigrateLegacyMatrixState, r as resolveMatrixMigrationStatus } from "./matrix-migration.runtime-CN0dqJb1.js";
...
import { a as singleAccountKeysToMove, i as resolveSingleAccountPromotionTarget, r as namedAccountPromotionKeys, t as matrixSetupAdapter } from "./setup-core-8eWs92RE.js";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-DCZEbzqg.js");
...
const loadMatrixChannelRuntime$1 = createLazyRuntimeNamedExport(() => import("./resolver.runtime-BNEOJ6ny.js"), "matrixResolverRuntime");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CzwHxsEb.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-DfLfMuyj.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
