...
import { l as resolveValidatedMatrixHomeserverUrl, s as resolveMatrixEnvAuthReadiness, u as validateMatrixHomeserverUrl } from "./config-C85OiREp.js";
import "./env-auth-BbmH3ZHW.js";
...
import { n as moveSingleMatrixAccountConfigToNamedAccount } from "./setup-core-8eWs92RE.js";
import { n as updateMatrixAccountConfig } from "./config-update-CZrXhUGk.js";
import "./client-CEQeYYpu.js";
import { n as listMatrixDirectoryGroupsLive, t as resolveMatrixTargets } from "./resolve-targets-CucKNyw7.js";
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-yB5Z0ui2.js");
