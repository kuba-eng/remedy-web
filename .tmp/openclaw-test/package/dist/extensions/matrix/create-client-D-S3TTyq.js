...
import { l as resolveValidatedMatrixHomeserverUrl } from "./config-C85OiREp.js";
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-CLWgBKVK.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-DDtubYsN.js"), import("./logging-CXcZxa4d.js")]).then(([sdkModule, loggingModule]) => ({
