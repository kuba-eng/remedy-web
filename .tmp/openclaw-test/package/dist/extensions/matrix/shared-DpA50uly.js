...
import { a as resolveMatrixAuthContext, i as resolveMatrixAuth } from "./config-C85OiREp.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-D-S3TTyq.js").then((n) => n.n).then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
