...
import { t as getActiveMatrixClient } from "./active-client-CNFkrloB.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-CEQeYYpu.js").then((n) => n.t), import("./shared-DpA50uly.js").then((n) => n.a)]).then(([clientModule, sharedModule]) => ({
