import { c as resolveTelegramAccount, f as resolveTelegramToken } from "./preview-streaming-DVSkw089.js";
import { n as parseTelegramReplyToMessageId, o as normalizeTelegramLookupTarget, r as parseTelegramThreadId, s as parseTelegramTarget } from "./outbound-params-qAI6uQHp.js";
import { i as telegramConfigAdapter, n as findTelegramTokenOwnerAccountId, o as lookupTelegramChatId, r as formatDuplicateTelegramTokenReason, t as createTelegramPluginBase } from "./shared-0WrK3LAO.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-BFw5FoOv.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt } from "./exec-approvals-BIZWJs62.js";
import { t as telegramApprovalCapability } from "./approval-native-r1LHlQ1K.js";
import { c as collectTelegramUnmentionedGroupIds, i as buildTelegramExecApprovalPendingPayload, o as telegramMessageActions$1, r as monitorTelegramProvider, s as auditTelegramGroupMembership, t as probeTelegram } from "./probe-MnLLdjAs.js";
import { g as buildTelegramGroupPeerId, r as markdownToTelegramHtmlChunks } from "./format-BReZcCfl.js";
import { n as listTelegramDirectoryGroupsFromConfig, r as listTelegramDirectoryPeersFromConfig, t as collectTelegramSecurityAuditFindings } from "./security-audit-BxYZ8Ueq.js";
import { t as resolveTelegramInlineButtons } from "./button-types-B0yPcKUi.js";
import { t as resolveTelegramReactionLevel } from "./reaction-level-DdsrFthQ.js";
import { t as getTelegramRuntime } from "./runtime-BAGnXbB2.js";
import { t as parseTelegramTopicConversation } from "./topic-conversation-BW17r5UT.js";
import { t as resolveTelegramSessionConversation } from "./session-conversation-BHOhYmMl.js";
import { i as telegramSetupAdapter, n as detectTelegramLegacyStateMigrations, r as telegramSetupWizard } from "./channel.setup-DUub0SNf.js";
import { a as setTelegramThreadBindingMaxAgeBySessionKey, i as setTelegramThreadBindingIdleTimeoutBySessionKey, t as createTelegramThreadBindingManager } from "./thread-bindings-Ka4TlPws.js";
...
import { appendMatchMetadata, asString, createComputedAccountStatusAdapter, createDefaultChannelRuntimeState, isRecord, resolveEnabledConfiguredAccountId } from "openclaw/plugin-sdk/status-helpers";
...
async function loadTelegramSendModule$1() {
	telegramSendModulePromise$1 ??= import("./send-BNARjKJk.js").then((n) => n.p);
...
async function loadTelegramSendModule() {
	telegramSendModulePromise ??= import("./send-BNARjKJk.js").then((n) => n.p);
