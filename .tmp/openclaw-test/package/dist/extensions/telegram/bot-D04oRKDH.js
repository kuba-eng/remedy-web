import { _ as wasSentByBot, a as editMessageTelegram, b as withTelegramApiErrorLogging, g as recordSentMessage, v as buildInlineKeyboard } from "./send-BNARjKJk.js";
import { c as resolveTelegramAccount, u as resolveTelegramMediaRuntimeOptions } from "./preview-streaming-DVSkw089.js";
import { t as normalizeTelegramReplyToMessageId } from "./outbound-params-qAI6uQHp.js";
import { r as resolveTelegramTransport } from "./fetch-BnXWv1D_.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-BFw5FoOv.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-BIZWJs62.js";
import { A as withResolvedTelegramForumFlag, B as resolveTelegramPrimaryMedia, C as resolveTelegramDirectPeerId, E as resolveTelegramGroupAllowFromContext, F as getTelegramTextParts, G as resolveSenderAllowMatch, H as isSenderAllowed, I as hasBotMention, M as buildSenderName, N as expandTextLinks, O as resolveTelegramStreamMode, P as extractTelegramLocation, R as normalizeForwardedContext, S as extractTelegramForumFlag, T as resolveTelegramForumThreadId, U as normalizeAllowFrom, V as firstDefined, W as normalizeDmAllowFromWithStore, _ as buildTelegramParentPeer, b as buildTypingThreadParams, c as isSafeToRetrySendError, g as buildTelegramGroupPeerId, h as buildTelegramGroupFrom, i as renderTelegramHtmlText, j as buildSenderLabel, k as resolveTelegramThreadSpec, l as isTelegramClientRejection, m as buildGroupLabel, p as tagTelegramNetworkError, s as isRecoverableTelegramNetworkError, v as buildTelegramRoutingTarget, w as resolveTelegramForumFlag, x as describeReplyTarget, y as buildTelegramThreadParams } from "./format-BReZcCfl.js";
import { c as buildModelsKeyboard, d as getModelsPageSize, f as parseModelCallbackData, l as buildProviderKeyboard, p as resolveModelSelection, t as buildCommandsPaginationKeyboard, u as calculateTotalPages } from "./command-ui-vCdy2jbK.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-LobYNlhi.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-Ka4TlPws.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-DPe-FgMY.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-CFU539VP.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-BtLZCelz.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-BNARjKJk.js").then((n) => n.p);
...
async function loadTelegramNativeCommandDeliveryRuntime() {
	telegramNativeCommandDeliveryRuntimePromise ??= import("./bot-native-commands.delivery.runtime-CyamIk1s.js");
...
async function loadTelegramNativeCommandRuntime() {
	telegramNativeCommandRuntimePromise ??= import("./bot-native-commands.runtime-B2-nNLMe.js");
...
async function resolveStickerVisionSupport$1(params) {
	try {
		const { resolveStickerVisionSupportRuntime } = await import("./sticker-vision.runtime-NWtGmr2j.js");
...
async function resolveTelegramInboundBody(params) {
	...
	if (hasAudio && !hasUserText && (!isGroup || requireMention && mentionRegexes.length > 0 && !disableAudioPreflight && senderAllowedForAudioPreflight)) try {
		const { transcribeFirstAudio } = await import("./media-understanding.runtime-CzVvyfkv.js");
...
async function loadTelegramMessageContextSessionRuntime(runtime) {
	...
	return {
		...await import("./bot-message-context.session.runtime-INCoydnT.js"),
		...runtime
	};
}
...
async function loadTelegramMessageContextRuntime() {
	telegramMessageContextRuntimePromise ??= import("./bot-message-context.runtime-Cg9tQDgK.js");
