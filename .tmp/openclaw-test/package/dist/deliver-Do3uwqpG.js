...
import { i as resolveMirroredTranscriptText } from "./transcript-Dzv6p1hl.js";
import { t as parseInlineDirectives } from "./directive-tags-_9B0F8vD.js";
import { r as isSilentReplyPayloadText } from "./tokens-C0hh0kYg.js";
...
import { a as toInternalMessageSentContext, d as toPluginMessageSentEvent, f as fireAndForgetHook, l as toPluginMessageContext, t as buildCanonicalSentMessageHookContext } from "./message-hook-mappers-BxmWtGkD.js";
import { l as failDelivery, o as ackDelivery, s as enqueueDelivery } from "./delivery-queue-CDEI8gW6.js";
import { a as shouldSuppressReasoningPayload, i as isRenderablePayload, r as formatBtwTextForExternalDelivery } from "./reply-payloads-BUYYfbBh.js";
...
async function loadTranscriptRuntime() {
	transcriptRuntimePromise ??= import("./transcript.runtime-CM8Og-4S.js");
	return await transcriptRuntimePromise;
}
let channelBootstrapRuntimePromise;
async function loadChannelBootstrapRuntime() {
	channelBootstrapRuntimePromise ??= import("./channel-bootstrap.runtime-BUC9ngE9.js");
