...
import { i as normalizeChannelId, n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-Cxw9jxnD.js";
...
import { a as normalizePluginsConfig } from "./config-state-spVXfsqB.js";
import { r as parseByteSize } from "./zod-schema-Bt6qsFkm.js";
...
import { a as getPreauthHandshakeTimeoutMsFromEnv, i as resolveDeviceAuthConnectErrorDetailCode, n as ConnectErrorDetailCodes, o as buildDeviceAuthPayload, r as resolveAuthConnectErrorDetailCode, s as buildDeviceAuthPayloadV3 } from "./client-CQUWcz_Z.js";
...
import { r as loadOpenClawPlugins, v as disposeRegisteredAgentHarnesses } from "./loader-mal3JrX6.js";
import { B as resolveMemoryLightDreamingConfig, F as resolveMemoryDeepDreamingConfig, I as resolveMemoryDreamingConfig, L as resolveMemoryDreamingPluginConfig, N as isSameMemoryDreamingDay, V as resolveMemoryRemDreamingConfig, z as resolveMemoryDreamingWorkspaces } from "./dreaming-Cps4W5Zx.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-CMbEm8J1.js";
import { s as getPluginCommandSpecs } from "./command-registration-IGV1CADF.js";
...
import { r as createPluginRuntimeLoaderLogger } from "./load-context-C-EwGkyR.js";
...
import { a as getModelRefStatus, c as resolveConfiguredModelRef, l as resolveHooksGmailModel, m as parseModelRef, o as normalizeModelSelection, p as normalizeModelRef, s as resolveAllowedModelRef, t as isCliProvider } from "./model-selection-cli-C6uOkXQy.js";
...
import { a as getModelRefStatus$1, d as resolveConfiguredModelRef$1, f as resolveDefaultModelForAgent, l as resolveAllowedModelRef$1, p as resolveHooksGmailModel$1, t as buildAllowedModelSet, x as resolveThinkingDefault, y as resolveSubagentConfiguredModelSelection } from "./model-selection-CaDDjSLe.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-DqcJmob1.js";
import { r as loadModelCatalog } from "./model-catalog-BW75gAXr.js";
import { n as resolveAgentIdentity } from "./identity-B_Q39IGW.js";
import { c as updateSessionStore, l as updateSessionStoreEntry, t as archiveRemovedSessionTranscripts } from "./store-DcFdQ7im.js";
...
import { n as resolveMainSessionKeyFromConfig, t as extractDeliveryInfo } from "./sessions-Cwh7H-GZ.js";
...
import { t as parseSessionThreadInfo } from "./thread-info-Rer12TrK.js";
...
import { n as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-BbEGX1JF.js";
import { o as startGatewayModelPricingRefresh } from "./usage-format-BUkQyCZx.js";
...
import { dt as listSessionCompactionCheckpoints, ut as getSessionCompactionCheckpoint } from "./model-context-tokens-Cs_NVRAP.js";
...
import { m as resolveEmbeddedAgentRuntime } from "./attempt.tool-run-context-Ca6EGee1.js";
import { n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-C0hh0kYg.js";
import { s as stripHeartbeatToken } from "./heartbeat-CuQlc5Sk.js";
...
import { d as resolvePluginTools, u as getPluginToolMeta } from "./channel-tools-Bn2KPJpS.js";
import { C as synthesizeSpeech, S as setTtsProvider, b as setTtsEnabled, c as isTtsEnabled, f as resolveExplicitTtsOverrides, g as resolveTtsProviderOrder, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, p as resolveTtsAutoMode, w as textToSpeech } from "./tts-Ba-Z27Wi.js";
import { n as compactEmbeddedPiSession, r as selectAgentHarness } from "./pi-embedded-runner-B47dT_1s.js";
import { i as supportsXHighThinking, t as formatThinkingLevels } from "./thinking-CtJu90cp.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-LlwtzBSE.js";
...
import { n as createOutboundPayloadPlan, s as projectOutboundPayloadPlanForMirror, t as deliverOutboundPayloads } from "./deliver-Do3uwqpG.js";
...
import { a as normalizeCronJobCreate, o as normalizeCronJobInput, s as normalizeCronJobPatch } from "./openclaw-tools-DiALg6WS.js";
...
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-DnPzMDWH.js";
...
import { c as setPreRestartDeferralCheck, n as deferGatewayRestartUntilIdle, o as scheduleGatewaySigusr1Restart, r as emitGatewayRestart, s as setGatewaySigusr1RestartPolicy } from "./restart-CuQak1Gc.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BAC4Mat9.js";
...
import { i as isKnownSecretTargetId } from "./target-registry-CbiKt_ns.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-DcVm4xbs.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-2A02Q58Y.js";
import { i as resolveOutboundSessionRoute, l as dispatchChannelMessageAction, o as resetDirectoryCache, r as ensureOutboundSessionEntry } from "./message-action-runner-w4QTVYZU.js";
import { n as normalizePollInput } from "./polls-C5l4CbhI.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-DHzxBGuz.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-B5bTbjdt.js";
...
import { r as resolveOutboundTarget } from "./targets-BoL6xRs_.js";
...
import { a as createRunningTaskRun, o as failTaskRunByRunId, r as completeTaskRunByRunId } from "./task-executor-NBG92XvQ.js";
import { _ as cleanupBrowserSessionsForLifecycleEnd, h as onSessionLifecycleEvent, o as initSubagentRegistry, p as scheduleSubagentOrphanRecovery, y as movePathToTrash } from "./subagent-registry-CwCba354.js";
import { r as clearSessionQueues } from "./queue-YLhvFyIi.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-DEVL8mXn.js";
import { a as isEmbeddedPiRunActive, f as waitForEmbeddedPiRunEnd, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-4UeQ_dZp.js";
import { h as stopDiagnosticHeartbeat, m as startDiagnosticHeartbeat } from "./diagnostic-CbadpMZv.js";
...
import { _ as verifyNodeToken, a as recordRemoteNodeInfo, b as registerSkillsChangeListener, c as removeRemoteNodeInfo, d as getPairedNode, f as listNodePairing, g as updatePairedNodeMetadata, h as requestNodePairing, i as primeRemoteSkillsCache, l as setSkillsRemoteRegistry, m as renamePairedNode, o as refreshRemoteBinsForConnectedNodes, p as rejectNodePairing, r as getRemoteSkillEligibility, s as refreshRemoteNodeBins, t as canExecRequestNode, u as approveNodePairing } from "./exec-defaults-fH2MXBpX.js";
import { s as loadWorkspaceSkillEntries } from "./skills-Dn9ygksH.js";
...
import { n as getActiveMemorySearchManager, r as resolveActiveMemoryBackendConfig } from "./memory-runtime-gDAw4ajX.js";
import { t as resolveMemorySearchConfig } from "./memory-search-A0u7eRDJ.js";
import { t as resolveModel } from "./model-44DYbL6S.js";
import { o as resolvePreferredSessionKeyForSessionIdMatches } from "./live-model-switch-_KR7SFEy.js";
import "./pi-embedded-CLlcNa7e.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-D33sU6YZ.js";
import { n as getAcpSessionManager } from "./manager-DFSlKQK-.js";
import { t as primeConfiguredBindingRegistry } from "./binding-registry-B0KJsX4-.js";
import { r as listPluginCommands } from "./commands-Bp4M_Tv6.js";
import { n as createPluginRuntime, r as setGatewaySubagentRuntime } from "./runtime-ZaaQ3_Bx.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-MHrd1pp9.js";
import "./commands-registry-CutbaAt1.js";
import { o as getTotalPendingReplies } from "./dispatch-D5lKrkc_.js";
...
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-ChONuhlG.js";
...
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-BIIFXMsF.js";
...
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-a7eRlgjK.js";
...
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-DsRO-GGc.js";
...
import { r as agentCommandFromIngress } from "./agent-command-C1A_VECZ.js";
import "./refresh-CdeTF0IG.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-BjbbrUHe.js";
...
import { a as respondUnavailableOnNodeInvokeError, i as respondInvalidParams, n as mergeGatewayAuthConfig, o as respondUnavailableOnThrow, r as mergeGatewayTailscaleConfig, s as safeParseJson, t as ensureGatewayStartupAuth } from "./startup-auth-9b1l_DxU.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DM6cISND.js";
import { r as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-B0ri9OTy.js";
import { _ as verifyDeviceToken, a as getPairedDevice, c as listDevicePairing, d as removePairedDevice, f as requestDevicePairing, g as updatePairedDeviceMetadata, h as summarizeDeviceTokens, i as formatDevicePairingForbiddenMessage, l as listEffectivePairedDeviceRoles, m as rotateDeviceToken, n as approveDevicePairing, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as ensureDeviceToken, s as listApprovedPairedDeviceRoles, t as approveBootstrapDevicePairing, u as rejectDevicePairing } from "./device-pairing-B7a6Ry9U.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-CAQX-5Ew.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-L59YjVyC.js";
import "./agent-DH9qYeaa.js";
import { n as shouldIncludeHook } from "./config-BVQdPBd5.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, i as buildSystemRunApprovalEnvBinding, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-BIT_pNwZ.js";
import { n as resolveSystemRunApprovalRequestContext, r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-CsjNoue2.js";
import { t as closeMcpLoopbackServer } from "./mcp-http-DLxCVDUu.js";
import { A as isSessionKeyAllowedByPrefix, B as resolveHookTargetAgentId, D as getHookChannelError, E as getHookAgentPolicyError, F as readJsonBody, H as applyHookMappings, I as resolveHookChannel, L as resolveHookDeliver, M as normalizeHookDispatchSessionKey, N as normalizeHookHeaders, O as getHookSessionKeyPrefixError, P as normalizeWakePayload, R as resolveHookIdempotencyKey, T as extractHookToken, U as resolveFunctionModuleExport, V as resolveHooksConfig, _ as sendGatewayAuthFailure, a as getHeader, h as loadGatewayModelCatalog, i as getBearerToken, j as normalizeAgentPayload, k as isHookAgentAllowed, l as resolveHttpBrowserOriginPolicy, m as __resetModelCatalogCacheForTest, p as resolveTrustedHttpOperatorScopes, r as authorizeGatewayHttpRequestOrReply, x as setDefaultSecurityHeaders, z as resolveHookSessionKey } from "./http-utils-CEMjw34U.js";
import { t as createOutboundSendDeps$1 } from "./outbound-send-deps-D_KC6JG3.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-BCYmFK6F.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BUOsTxuM.js";
import { t as loadProviderUsageSummary } from "./provider-usage-kZ5NsgPI.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-BspfEZO5.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-D2mNgNDo.js";
import { o as fetchClawHubSkillDetail } from "./clawhub-S3mak4ZT.js";
import { a as loadSessionUsageTimeSeries, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-Dclrc0hk.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-WYP4cPXL.js";
import { a as performGatewaySessionReset } from "./session-reset-service-Cgq56Dr4.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-mL3aAXWm.js";
import { m as normalizeUpdateChannel, n as compareSemverStrings, o as resolveNpmChannelTag, t as checkUpdateStatus } from "./update-check-DpGUvJ3n.js";
import { a as removeBackfillDiaryEntries, c as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeGroundedShortTermCandidates, r as previewGroundedRemMarkdown, s as repairDreamingArtifacts } from "./memory-core-bundled-runtime-CDGaKFt2.js";
import { t as buildChannelUiCatalog } from "./catalog-C3s-SZqp.js";
import { a as resolveGatewayStartupPluginIds, r as resolveConfiguredDeferredChannelPluginIds } from "./channel-plugin-ids-B746ZNBl.js";
import { a as redactConfigSnapshot, i as redactConfigObject, o as restoreRedactedValues, r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-x_mfyq9R.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-Bs7haulH.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-HjENoSk_.js";
import { t as GatewayLockError } from "./gateway-lock-CUHYEfEH.js";
import { t as loadWorkspaceHookEntries } from "./workspace-Bx9Ly48y.js";
import { t as readConfiguredLogTail } from "./log-tail-DapzMs5Q.js";
import { o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CSF-8MDB.js";
import { n as getHealthSnapshot } from "./health-C5SwKW4E.js";
import { t as installSkill } from "./skills-install-C_gBNvzW.js";
import { n as runChannelPluginStartupMaintenance, r as runGatewayUpdate, t as normalizeCronJobIdentityFields } from "./normalize-job-identity-suoQ_oWd.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-C-KVnRne.js";
import { t as runSetupWizard } from "./setup-DzmwiLW-.js";
import "./status-jUIL9SKL.js";
import { t as getStatusSummary } from "./status.summary-DV3lEbfb.js";
import { d as startTaskRegistryMaintenance, f as stopTaskRegistryMaintenance, g as markCronJobActive, h as clearCronJobActive, n as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-CGbNg9Or.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-CP4GraI6.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeLogArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-C9H242VT.js";
import { t as buildChannelAccountSnapshot } from "./status-C-MWMPzR.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-0yVP5--0.js";
import { i as resolveHeartbeatAckMaxChars$1, r as resolveCronPayloadOutcome, t as isHeartbeatOnlyResponse } from "./helpers-BGBRXk_r.js";
import { n as markCronSessionPreRun, r as persistCronSkillsSnapshotIfChanged, t as createPersistCronSessionEntry } from "./run-session-state-DYtb_E36.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CibgF2RJ.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CfbJPCQJ.js";
import { n as MediaOffloadError, r as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-R8vhdMCf.js";
import { a as resolveCronSession, n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-B6-gVrxg.js";
import { _ as injectTimestamp, a as DEDUPE_TTL_MS, c as MAX_PAYLOAD_BYTES, d as isSuppressedControlReplyLeadFragment, f as isSuppressedControlReplyText, g as waitForTerminalGatewayDedupe, h as setGatewayDedupeEntry, i as DEDUPE_MAX, l as MAX_PREAUTH_PAYLOAD_BYTES, m as readTerminalSnapshotFromGatewayDedupe, n as chatHandlers, o as HEALTH_REFRESH_INTERVAL_MS, p as abortChatRunById, s as MAX_BUFFERED_BYTES, u as TICK_INTERVAL_MS, v as timestampOptsFromConfig } from "./chat-D0cJLkS3.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-BsGaTWnQ.js");
...
async function loadSkillsSnapshotRuntime() {
	skillsSnapshotRuntimePromise ??= import("./skills-snapshot.runtime-LX6RzNxa.js");
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-Bnxdpolu.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-DwhOfRtk.js");
}
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-DgS6Lag0.js");
}
...
function resolveConfiguredProviders(cfg) {
	...
	for (const [id, provider] of Object.entries(cfg.models?.providers ?? {})) {
		...
		if (provider?.apiKey !== void 0 && provider?.apiKey !== null) continue;
		out.add(id);
		if (mode === "oauth") expectsOAuth.add(id);
	}
	for (const profile of Object.values(cfg.auth?.profiles ?? {})) {
		const provider = profile?.provider;
		const mode = profile?.mode;
		if (typeof provider === "string" && provider.length > 0 && (mode === "oauth" || mode === "token")) {
			out.add(provider);
			if (mode === "oauth") expectsOAuth.add(provider);
		}
	}
	return {
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CLm1p1NY.js");
...
const sessionsHandlers = {
	...
	"sessions.reset": async ({ params, respond, context }) => {
		...
		const { performGatewaySessionReset } = await import("./sessions.runtime-DRVCuC0q.js");
		const result = await performGatewaySessionReset({
			key,
			reason,
	...
	"sessions.delete": async ({ params, respond, client, isWebchatConnect, context }) => {
		...
		const { archiveSessionTranscriptsForSessionDetailed, cleanupSessionBeforeMutation, emitGatewaySessionEndPluginHook, emitSessionUnboundLifecycleEvent } = await import("./sessions.runtime-DRVCuC0q.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-BHjUDzEo.js");
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-Bl72dhOW.js");
...
function getBundledChannelsModule() {
	bundledChannelsModulePromise ??= import("./bundled-SVkVDADU.js");
...
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-CmAoAnK2.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-B0NB8Tq3.js");
	return embeddingsHttpModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-WY4EMlED.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-DUPiKTWf.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-GlNQ6qct.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-Bue7mhzA.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-BqjWtjAQ.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-CapIdoPr.js");
