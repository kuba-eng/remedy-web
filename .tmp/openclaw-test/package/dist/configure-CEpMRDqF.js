...
import { a as loadConfig, l as readConfigFileSnapshot } from "./io-CnRB4FES.js";
...
import { r as replaceConfigFile, t as ConfigMutationConflictError } from "./config-Cs9i9cxO.js";
...
import { n as resolveProviderPluginChoice } from "./provider-wizard-DY-FNGBy.js";
import { t as applyPrimaryModel } from "./provider-model-primary-C67a1ZPp.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-zM35EBu2.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-HjENoSk_.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-BkuasxUg.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-B1OiPKVG.js";
import { n as applyAuthChoice } from "./auth-choice-Co3xjsUW.js";
import { a as noteChannelStatus, i as setupChannels, s as shouldShowChannelInSetup } from "./onboard-channels-CyKucAOs.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-_PZ5qxAa.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CxqJoVNy.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-CoNmhxzH.js";
import { i as promptCustomApiConfig } from "./onboard-custom-DlazzmB8.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-Cr2a6Qig.js";
import { t as formatHealthCheckFailure } from "./health-format-CJ-K7j7d.js";
import { r as healthCommand } from "./health-C5SwKW4E.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-CGEgACrJ.js";
import { t as setupSkills } from "./onboard-skills-BIklUkTw.js";
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-BjHDnlfy.js");
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-Cb784Zl3.js");
	...
	try {
		...
		if (opts.sections) {
			...
			if (selected.includes("plugins")) {
				const { configurePluginConfig } = await import("./setup.plugin-config-CaHWyYwb.js");
