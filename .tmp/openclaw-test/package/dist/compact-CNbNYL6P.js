...
import { C as trackSessionManagerAccess, D as getDmHistoryLimitFromSessionKey, E as buildEmbeddedMessageActionDiscoveryInput, F as consumeCompactionSafeguardCancelReason, I as setCompactionSafeguardCancelReason, L as compactWithSafetyTimeout, M as hasMeaningfulConversationContent, N as isRealConversationMessage, O as limitHistoryTurns, Q as createPreparedEmbeddedPiSettingsManager, R as resolveCompactionTimeoutMs, S as prewarmSessionFile, T as validateReplayTurns, U as guardSessionManager, V as resolveTranscriptPolicy, Z as repairSessionFileIfNeeded, a as runAfterCompactionHooks, b as resolveEmbeddedAgentStreamFn, ct as captureCompactionCheckpointSnapshot, d as mapThinkingLevel, f as splitSdkTools, ft as persistSessionCompactionCheckpoint, g as createSystemPromptOverride, h as buildEmbeddedSystemPrompt, i as estimateTokensAfterCompaction, it as resolveChannelCapabilities, k as buildEmbeddedExtensionFactories, l as resolveEmbeddedCompactionTarget, lt as cleanupCompactionCheckpointSnapshot, m as applySystemPromptOverrideToSession, n as asCompactionHookRunner, o as runBeforeCompactionHooks, ot as isHeartbeatOkResponse, p as collectAllowedToolNames, pt as resolveSessionCompactionCheckpointReason, r as buildBeforeCompactionHookMetrics, s as runPostCompactionSideEffects, st as isHeartbeatUserMessage, t as readPiModelContextTokens, tt as createBundleLspToolRuntime, u as flushPendingToolResultsAfterIdle, v as resolveEmbeddedAgentApiKey, w as sanitizeSessionHistory, x as resolveEmbeddedRunSkillEntries, y as resolveEmbeddedAgentBaseStreamFn } from "./model-context-tokens-Cs_NVRAP.js";
...
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolCapabilities, s as resolveChannelMessageToolHints } from "./channel-tools-Bn2KPJpS.js";
...
import { i as resolveBootstrapContextForRun, o as resolveHeartbeatPromptForSystemPrompt, r as makeBootstrapWarn } from "./bootstrap-files-C-CHHEiH.js";
import { h as ensureSessionHeader, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-TPhagF-2.js";
...
import { c as resolveModelAuthMode, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride } from "./model-auth-8pQph1lv.js";
import { a as shouldUseOpenAIWebSocketTransport, c as supportsModelTools, o as logProviderToolSchemaDiagnostics, s as normalizeProviderToolSchemas } from "./attempt.thread-helpers-BaAu7Y0G.js";
import { n as registerProviderStreamForModel } from "./anthropic-vertex-stream-CJjqZvdc.js";
import { t as log } from "./logger-CMwqWyWx.js";
import { t as createBundleMcpToolRuntime } from "./pi-bundle-mcp-tools-B7xUtJY4.js";
...
import { a as sanitizeToolUseResultPairing } from "./session-transcript-repair-CGy5XjJZ.js";
...
import { t as applyExtraParamsToAgent } from "./extra-params-plhpzG_s.js";
