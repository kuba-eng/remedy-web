...
import { i as normalizeChannelId$1, t as getChannelPlugin } from "./registry-Cxw9jxnD.js";
...
import { n as resolveChannelApprovalCapability } from "./plugins-CMbEm8J1.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-4i4Rq3Qq.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-BeAV2xDF.js";
...
import { i as formatUsd, r as formatTokenCount } from "./usage-format-BUkQyCZx.js";
...
import { S as setTtsProvider, _ as setLastTtsAttempt, a as getTtsMaxLength, b as setTtsEnabled, c as isTtsEnabled, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, r as getLastTtsAttempt, s as isSummarizationEnabled, v as setSummarizationEnabled, w as textToSpeech, x as setTtsMaxLength } from "./tts-Ba-Z27Wi.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-BfULAZ3v.js";
import { g as resolveBootstrapMaxChars, v as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-TPhagF-2.js";
...
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-D0eYNcrb.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CerCSf1M.js";
import { r as callGateway } from "./call-DKkbbXOF.js";
import { l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart } from "./restart-CuQak1Gc.js";
...
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-DwXcT5Mm.js";
...
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot } from "./runs-4UeQ_dZp.js";
import "./diagnostic-CbadpMZv.js";
import { t as formatDurationCompact } from "./format-duration-D2oH-5yd.js";
import { O as getFinishedSession, k as getSession } from "./bash-tools.exec-runtime-CIGX5RS2.js";
import "./sandbox-D4u0AS1F.js";
import { o as stripToolResultDetails } from "./session-transcript-repair-CGy5XjJZ.js";
...
import { r as resolveModelWithRegistry } from "./model-44DYbL6S.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-Bp4M_Tv6.js";
...
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-LL-lUou6.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-C5z1LtuO.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-C1gCCTpi.js";
...
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-DGm7pv-N.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-Bn59G1Y3.js";
import { t as extractBtwQuestion } from "./btw-command-BxaOEAXq.js";
...
import { t as handleAcpCommand } from "./commands-acp-Cp7APFBy.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-0F0zKquL.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DM6cISND.js";
import { r as handleModelsCommand } from "./commands-models-CjlanAVK.js";
import { n as setPluginEnabledInConfig } from "./enable-_NWO7buj.js";
import { n as createExecTool } from "./bash-tools-DKB2Pd_o.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-DEGF-R-0.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-CzZodx0I.js";
import { f as resolveSubagentsAction, h as resolveCommandSurfaceChannel, l as resolveHandledPrefix, m as resolveChannelAccountId, p as stopWithText, u as resolveRequesterSessionKey } from "./shared-O6yPOPdc.js";
import { n as buildToolsMessage } from "./status-DIXjm08D.js";
import { t as parseConfigValue } from "./config-value-Bi9xb5wq.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-D2mNgNDo.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-C-nuIYtB.js";
import { t as buildStatusReply } from "./commands-status-U8PT-J-Z.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-CavOrYnr.js";
import { m as parseClawHubPluginSpec } from "./clawhub-S3mak4ZT.js";
import { r as installPluginFromClawHub } from "./clawhub-CH2VaIsx.js";
import { a as buildPluginInspectReport, i as buildPluginDiagnosticsReport, o as buildPluginSnapshotReport, s as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-DAe0C2Hb.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-BZ6ST8q_.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-Dclrc0hk.js";
...
const handleCompactCommand = async (params) => {
	...
	const runtime = await import("./commands-compact.runtime-CJRYWJ2Q.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-B-KT1iv3.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-Dd_f1gGD.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-BKcsdlcm.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-BFsIZlBF.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-DGJJCHEI.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-yw9wPdZz.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-DISAy8EW.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-U6_gFkwm.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-B7WTQ62X.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-Cc-yO7Th.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-Ct-n-6qZ.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-DdgnEori.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-Dji5xeu_.js");
