...
import { a as resolveMSTeamsCredentials } from "./token-BVJ7j6Yc.js";
...
async function loadMSTeamsSdk() {
	const [appsModule, apiModule] = await Promise.all([import("./dist-DTArjRQZ.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-BZluJOpr.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
	return {
		App: appsModule.App,
...
async function createBotFrameworkJwtValidator(creds) {
	const jwt = await import("./jsonwebtoken-CErFAmGB.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { JwksClient } = await import("./src-CHRw7I13.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
async function resolveGraphToken(cfg, options) {
	...
	if (options?.preferDelegated && msteamsCfg?.delegatedAuth?.enabled && creds.type === "secret") {
		const { resolveDelegatedAccessToken } = await import("./token-BmyzULsq.js");
