...
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-D0uyapBr.js";
...
import { i as hasNonEmptyString } from "./channel-target-BtLMvaVs.js";
import { t as hasPotentialConfiguredChannels } from "./config-presence-BA5i4XO5.js";
...
import { t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-buRHPtm7.js";
import path from "node:path";
import { isIP } from "node:net";
//#region src/security/audit-deep-code-safety.ts
let auditDeepModulePromise;
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-BfHx-ETD.js");
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-B_uiUpJ5.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-Bq3LwGDp.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-YD4JhEdF.js");
	return await auditChannelModulePromise;
}
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-CC_wbL_A.js");
	return await pluginRegistryLoaderModulePromise;
}
async function loadPluginMetadataRegistryLoaderModule() {
	pluginMetadataRegistryLoaderModulePromise ??= import("./metadata-registry-loader-BBT1udmD.js");
...
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-Ce_iOEXl.js"),
		import("./probe-auth-CsieyBmE.js"),
		import("./probe-Cahs8gtN.js")
