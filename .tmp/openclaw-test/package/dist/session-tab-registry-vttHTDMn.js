...
import { t as resolveBrowserRateLimitMessage } from "./rate-limit-message-BXr5x9i1.js";
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-CChaclZ1.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-CKGzpi1r.js");
